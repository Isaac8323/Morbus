...
public class Archivos : MonoBehaviour
{
    ...
    public void Crear()
    {
        ...
        else
        {
           ...
           Datos = new DatosdeJuego();
            ...
            //Cantidad
            Datos.Personajes[0, 2] = cantidades_formulas[0];
            Datos.Personajes[1, 2] = cantidades_formulas[1];
            Datos.Personajes[2, 2] = cantidades_formulas[2];
            Datos.Personajes[3, 2] = cantidades_formulas[3];
            Datos.Personajes[4, 2] = cantidades_formulas[4];
            Datos.Personajes[5, 2] = cantidades_formulas[5];
            Datos.Personajes[6, 2] = cantidades_formulas[6];
            Datos.Personajes[7, 2] = cantidades_formulas[7];
            Datos.Personajes[8, 2] = cantidades_formulas[8];
            Datos.Personajes[9, 2] = cantidades_formulas[9];
            Datos.Personajes[10, 2] = cantidades_formulas[10];
            Datos.Personajes[11, 2] = cantidades_formulas[11];
            Datos.Personajes[12, 2] = cantidades_formulas[12];
            Datos.Personajes[13, 2] = cantidades_formulas[13];
            Datos.Personajes[14, 2] = cantidades_formulas[14];
            Datos.Personajes[15, 2] = cantidades_formulas[15];
            Datos.Personajes[16, 2] = cantidades_formulas[16];
            Datos.Personajes[17, 2] = cantidades_formulas[17];
            Datos.Personajes[18, 2] = cantidades_formulas[18];
            Datos.Personajes[19, 2] = cantidades_formulas[19];
            Datos.Personajes[20, 2] = cantidades_formulas[20];
            Datos.Personajes[21, 2] = cantidades_formulas[21];
            Datos.Personajes[22, 2] = cantidades_formulas[22];
            Datos.Personajes[23, 2] = cantidades_formulas[23];
            Datos.Personajes[24, 2] = cantidades_formulas[24];
            //Descripciones
          ...
          //Estructuracion
            ...
            //Cantidad Elemento
            Datos.Elementos[0, 1] =cantidades_elementos[0];
            Datos.Elementos[1, 1] = cantidades_elementos[1];
            Datos.Elementos[2, 1] = cantidades_elementos[2];
            Datos.Elementos[3, 1] = cantidades_elementos[3];
            Datos.Elementos[4, 1] = cantidades_elementos[4];
            Datos.Elementos[5, 1] = cantidades_elementos[5];
            Datos.Elementos[6, 1] = cantidades_elementos[6];
            Datos.Elementos[7, 1] = cantidades_elementos[7];
            Datos.Elementos[8, 1] = cantidades_elementos[8];
            Datos.Elementos[9, 1] = cantidades_elementos[9];
            Datos.Elementos[10, 4] = cantidades_elementos[10];
    ...
    public void Guardar()
    {
        ...
        Datos.Elementos[1, 1] = "500";
        Datos.Elementos[2, 1] = "130";
        Datos.Elementos[3, 1] = "800";
        Datos.Elementos[4, 1] = "900";
        Datos.Elementos[5, 1] = "600";
        Datos.Elementos[6, 1] = "200";
        Datos.Elementos[7, 1] = "100";
        Datos.Elementos[8, 1] = "700";
        Datos.Elementos[9, 1] = "300";
        Datos.Elementos[10, 4] = "150";
        //Descripcion Elemento
        Datos.Elementos[0, 2] = "elemntin1";
        Datos.Elementos[1, 2] = "elemntin2";
        Datos.Elementos[2, 2] = "elemntin3";
    ...
    //}
    //funcion para cargar datos en la escena del laboratorio
    public void Escenario_estructuracion(String formula_estructuracion)
    {
       Datos.estructuracion= formula_estructuracion ;
       Debug.Log(Datos.estructuracion);
    }
...
class DatosdeJuego : System.Object
{
    ...
    public String [,] Personajes = new String[25, 5];
