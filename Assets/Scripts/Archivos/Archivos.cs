...
public class Archivos : MonoBehaviour
{
    ...
    public void Crear()
    {
        ...
        else
        {
            ...
            Datos.Personajes[21, 2] = "0";
            Datos.Personajes[22, 2] = "0";
            ...
            Datos.bismuto = "0"; //Debe ser 0
            Datos.level[0] = "1"; //Debe ser 1
            Datos.experiencia = "800"; //Debe ser 0, 
            Datos.nivel_organismo_jefes = "1"; //Debe ser 1
            Datos.sesion = "";
            Datos.estructuracion = "";
            Datos.mantenimient = "0";
            Datos.Tutorial = "0";//Debe ser 0, para no ver ninguno poner valor arriba de 9
